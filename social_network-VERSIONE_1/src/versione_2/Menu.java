...
public class Menu {
	...
	public static String MESSAGGIO_INTERESSI=LINEA+"SELEZIONA LE TUE CATEGORIE DI INTERESSE CON L'INDICE (UNA PER VOLTA) O PREMI -1 PER SALTARE\n";
