...
public class Menu {
	...
	public static String MESSAGGIO_PUBBLICAZIONE =LINEA+"SELEZIONA UNA PROPOSTA CON IL NUMERO DI INDICE PER VISUALIZZARE I DETTAGLI E PUBBLICARLA O CANCELLARLA\n"
			+ "OPPURE 0 PER TORNARE INDIETRO";
	public static String GESTIONE_PROPOSTA=LINEA+"COSA VUOI FARE?\n"
	...
	public static String DATI="DATA2.save";
